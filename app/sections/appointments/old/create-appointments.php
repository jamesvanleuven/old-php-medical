										...
										<img src="//<?=$http_host; ?>/pub/img/placeholder-user.png" class="avatar img-responsive img-thumbnail tn-appointment">
											<address class="contact">
												<small>
													...
													<abbr title="Phone"><i class="fa fa-phone"></i> <a class="tel" href="tel:"> (123) 456-7890</a></abbr><br>
													<abbr title="SMS"><i class="fa fa-comment"></i> <a class="sms" href="msg:">(123) 456-7890</a></abbr></a>
												</small>
											</address>
															...
															<div class="tab-pane child-panel active" id="details-create">
																<div class="container-fluid">
																	...
																	<div class="row">
																		<div class="col-md-12">
																			<ul class="list-group">
																				<li class="list-group-item"><strong>Name: </strong> <a href="javascript:void(0);" id="name" data-type="text" data-pk="1" data-title="patient name" class="text name editable editable-click">patient name</a></li>
																				<li class="list-group-item"><strong>Phone: </strong> <a href="javascript:void(0);" id="tel" data-type="tel" data-pk="1" data-title="Phone" class="text phone editable editable-click">Patient Number</a></li>
																				<li class="list-group-item"><strong>Email: </strong> <a href="javascript:void(0);" id="email" data-type="text" data-pk="1" data-title="Email" class="text email editable editable-click">Patient Email</a></li>
																				<li class="list-group-item"><strong>Street: </strong> <a href="javascript:void(0);" id="street" data-type="text" data-pk="1" data-title="Street Address" class="text street editable editable-click">Patient Street Address</a></li>
																				<li class="list-group-item"><strong>Unit: </strong> <a href="javascript:void(0);" id="suite" data-type="text" data-pk="1" data-title="Unit Address" class="text suite editable editable-click">Patient Suite Number</a></li>
																				...
																				<li class="list-group-item"><strong>Country: </strong> <a href="javascript:void(0);" id="country" data-type="text" data-pk="1" data-title="Country" class="text country editable editable-click">Patient Country</a></li>
																				<li class="list-group-item"><strong>Postal Code: </strong> <a href="javascript:void(0);" id="zipcode" data-type="text" data-pattern="[A-Za-z][0-9][A-Za-z] [0-9][A-Za-z][0-9]" data-pk="1" data-title="Postal Code" class="text zipcode editable editable-click">Patient Postal/Zipcode</a></li>
																			</ul>
																		</div>
																	</div>
																</div>
