															...
															<div class="tab-pane child-panel active" id="details">
																<div class="container-fluid">
																	...
																	<div class="row">
																		<div class="col-md-12">
																			<ul class="list-group">
																				<li class="list-group-item"><strong>Name: </strong> <a href="javascript:void(0);" id="name" data-type="text" data-pk="1" data-title="Mickey Mouse" class="text editable editable-click">Mickey Mouse</a></li>
																				<li class="list-group-item"><strong>Phone: </strong> <a href="javascript:void(0);" id="tel" data-type="tel" data-pk="1" data-title="604-555-1234" class="text editable editable-click">604-555-1234</a></li>
																				<li class="list-group-item"><strong>Email: </strong> <a href="javascript:void(0);" id="email" data-type="text" data-pk="1" data-title="mickey@mouse.com" class="text editable editable-click">mickey@mouse.com</a></li>
																				<li class="list-group-item"><strong>Street: </strong> <a href="javascript:void(0);" id="street" data-type="text" data-pk="1" data-title="795 Folsom Ave" class="text editable editable-click">795 Folsom Ave</a></li>
																				<li class="list-group-item"><strong>Unit: </strong> <a href="javascript:void(0);" id="street" data-type="text" data-pk="1" data-title="Suite 600" class="text editable editable-click">Suite 600</a></li>
																				<li class="list-group-item"><strong>City: </strong> <a href="javascript:void(0);" id="region-edit" data-type="select" data-pk="1" data-title="North Vancouver" class="region editable editable-click">North Vancouver</a></li>
																				<li class="list-group-item"><strong>State/Province: </strong> <a href="javascript:void(0);" id="state-edit" data-type="select" data-pk="1" data-title="British Columbia" class="state editable editable-click">British Columbia</a></li>
																				<li class="list-group-item"><strong>Country: </strong> <a href="javascript:void(0);" id="country" data-type="text" data-pk="1" data-title="USA" class="text editable editable-click">USA</a></li>
																				<li class="list-group-item"><strong>Postal Code: </strong> <a href="javascript:void(0);" id="zipcode" data-type="text" data-pattern="[A-Za-z][0-9][A-Za-z] [0-9][A-Za-z][0-9]" data-pk="1" data-title="94107" class="text editable editable-click">94107</a></li>
																			</ul>
																		</div>
																	</div>
																</div>
										...
										<p class="pull-left">
											<ul class="list-inline">
												<li><input type="radio" id="ico_cash" name="payment_type" data-type="ico_cash.jpg" value="cash">
													<label for="ico_cash">
														<img title="Cash Payment" class="img-thumbnail cc-icons" src="//<?=$http_host;?>/pub/img/ico_cash.jpg"></label></li>
												<li><input type="radio" id="ico_debit" name="payment_type" data-type="ico_debit.jpg" value="debit" checked>
													<label for="ico_debit">
														<img title="Interac Debit" class="img-thumbnail cc-icons" src="//<?=$http_host;?>/pub/img/ico_debit.jpg"></label></li>
												<li><input type="radio" id="ico_visa" name="payment_type" class="cc" data-type="ico_visa.jpg" value="visa">
													<label for="ico_visa">
														<img title="Visa Payment" class="img-thumbnail cc-icons" src="//<?=$http_host;?>/pub/img/ico_visa.jpg"></label></li>
												<li><input type="radio" id="ico_mc" name="payment_type" class="cc" data-type="ico_mc.jpg" value="mc">
													<label for="ico_mc">
														<img title="Mastercard Payment" class="img-thumbnail cc-icons" src="//<?=$http_host;?>/pub/img/ico_mc.jpg"></label></li>
												<li><input type="radio" id="ico_amex" name="payment_type" class="cc" data-type="ico_amex.jpg" value="amex">
													<label for="ico_amex">
														<img title="American Express Payment" class="img-thumbnail cc-icons" src="//<?=$http_host;?>/pub/img/ico_amex.jpg"></label></li>
											</ul>
										</p>
									</div>
								</div>
